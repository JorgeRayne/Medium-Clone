<div class="flex bg-white border border-gray-200 rounded-lg shadow-sm dark:bg-gray-800 dark:border-gray-700 mb-8">   
    ...
    <a href="#">
        ...
        {{-- <img class="w-48 h-full max-h-64 object-cover rounded-t-lg" src="{{ Storage::url($post->image) }}" alt="#" /> --}}
        <img class="w-48 h-full max-h-64 object-cover rounded-t-lg" src="{{ $post->imageUrl() }}" alt="#" />
    </a>
</div> 